...
- (void)commonInit {
    ...
    _mode = MBProgressHUDModeIndeterminate;  // MBProgressHUDModeIndeterminate
    _margin = 20.0f;
    _opacity = 1.f;
...
- (void)setupViews {
    ...
    backgroundView.style = MBProgressHUDBackgroundStyleSolidColor; // MBProgressHUDBackgroundStyleSolidColor
...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        _progress = 0.f;
        _lineColor = [UIColor whiteColor]; //whiteColor
        _progressColor = [UIColor whiteColor];   //whiteColor
    ...
    if ((self = [super initWithFrame:frame])) {
        if (kCFCoreFoundationVersionNumber >= kCFCoreFoundationVersionNumber_iOS_7_0) {
            ...
            if (kCFCoreFoundationVersionNumber >= kCFCoreFoundationVersionNumber_iOS_8_0) {
                // adithya
                _color = [UIColor colorWithWhite:0.8f alpha:0.1f];
